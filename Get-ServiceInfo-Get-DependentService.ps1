...
function Get-ServiceInfo{
    ...
    @{Name='DesktopInteract'; Expression={$wmiObject.DesktopInteract}},
    @{Name='ExitCode'; Expression={$wmiObject.ExitCode}},
    @{Name='ServiceSpecificExitCode'; Expression={$wmiObject.ServiceSpecificExitCode}},
    @{Name='CheckPoint'; Expression={$wmiObject.CheckPoint}},
    @{Name='WaitHint'; Expression={$wmiObject.WaitHint}},
